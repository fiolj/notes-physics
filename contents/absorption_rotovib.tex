...
\begin{aclaracion}[]
  ...
  \item Wigner-Eckart theorem (see (\ref{Q:W-E-theorem-usual}) on appendix \ref{S:wign-eckart-theor})
    ...
    \end{equation}
  % \item Clebsh-Gordan coefficients (for adding $j_{1}, j_{2}$ to get $J$)
  %   \begin{equation} \label{Q:C-G-definition}
  %     \langle J M|j_{1} m_{1} j_{2} m_{2}\rangle  \equiv \langle j_{1} m_{1} j_{2} m_{2}| J M\rangle 
  %   \end{equation}

  % \item Clebsh-Gordan symmetries
  %   \begin{subequations}
  %     \begin{align}
  ...
  %       \label{Q:C-G-symmetries-4} & = (-1)^{j_1 - m_1} \sqrt{\frac{2 J +1}{2 j_2 +1}} \langle J M j_1 \, {-m_1} | j_2 m_2 \rangle
  %     \end{align}
  %   \end{subequations}
