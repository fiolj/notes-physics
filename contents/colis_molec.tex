...
\begin{equation}
  ...
  \vect{F}^{\text{(e)}}_{X} = \frac{\partial U_{1}}{\partial r_{S,i}} = \sum_{\ell=1}^{6} \frac{\partial U_{1}}{\partial r_{\ell S,i}} \overbrace{ \frac{\partial r_{\ell S,i}}{\partial r_{S,i}}}^{-1} = - 3 A p \sum_{\ell=1}^{6} \cos \theta_{\ell}\, \rme^{-b r_{\ell}} \,  \left( \frac{1}{r_{\ell}} + \cos \theta_{\ell}\frac{1}{r_{\ell X}} \right) \vers{r}_{\ell X} 
\end{equation}
