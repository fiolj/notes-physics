...
\end{align}
% \begin{align}
%   (BXX)^{(e)}_{ij} =& \frac{\partial F^{(e)}_{X,i}}{\partial r_{X,j}} = -3 A p \, \Sum_{\ell} e^{-br_{\ell}} \, \Biggl\{\frac{1}{r_{\ell}} \cos \theta_{\ell} \frac{\partial (r_{\ell X,i}/r_{\ell X})}{\partial r_{\ell X,j}} + (r_{\ell X,i}/r_{\ell X}) \frac{\partial \cos \theta_{\ell}}{\partial r_{\ell X,j}}\biggr\}
% \end{align}
\begin{align}
