...
% \input{figures/coordenadas.tikz}
...
\intertext{donde }
    ...
    B&= 2 \cos \theta_{\ell} \frac{r_{\ell X,i}}{r^{2}_{\ell X}}\left( \frac{\partial \cos \theta_{\ell}}{\partial r_{\ell X,j}} \right)  + \cos^{2} \theta_{l}\frac{\partial ({r_{\ell X,i}}/{r^{2}_{\ell X}})}{\partial r_{\ell X,j}}
       \intertext{con}
...
\begin{subequations}
  \begin{align}
    (BXF_{\ell})^{(e)}_{ij} = \frac{\partial F^{(e)}_{X,i}}{\partial r_{\ell,j}} = -3 A p \, \Biggl\{ \overbrace{\frac{\partial}{\partial r_{F_{\ell},j}} \left[{\cos {\theta_{\ell}}}\, \frac{\rme^{-b r_{\ell}}}{r_{\ell}}\, \frac{r_{\ell X,i}}{r_{\ell X}}\right]}^{C} + \overbrace{\frac{\partial}{\partial r_{F_{\ell},j}} \left[{\cos^{2}{\theta_{\ell}}} \,\rme^{-b r_{\ell}}\, \frac{r_{\ell X,i}}{r_{\ell X}^{2}} \right]}^{D}\biggr\} 
    % \nonumber
    \intertext{donde }
    C = -\frac{\rme^{-b r_{\ell}}}{r_{\ell}}\, \frac{r_{\ell X,i}}{r_{\ell X}} \left( \frac{\partial \cos \theta_{\ell}}{\partial r_{\ell,j}} \right)  - 
    \cos \theta_{\ell} \frac{r_{\ell X,i}}{r_{\ell X}} \left( \frac{\partial (\rme^{-b r_{\ell}}/r_{\ell})}{\partial r_{\ell,j}} \right) 
    +
    \frac{\rme^{-b r_{\ell}}}{r_{\ell}} \cos \theta_{\ell} \left( \frac{\partial (r_{\ell X,i}/r_{\ell})}{\partial r_{\ell X,j}} \right) 
    % \\
    % \cos \theta_{\ell} \frac{\partial ({r_{\ell X,i}}/{r_{\ell X}})}{\partial r_{\ell X,j}}  \, \\
    % B&= 2 \cos \theta_{\ell} \frac{r_{\ell X,i}}{r^{2}_{\ell X}}\left( \frac{\partial
    %   \cos \theta_{\ell}}{\partial r_{\ell X,j}} \right) + \cos^{2}
    % \theta_{l}\frac{\partial ({r_{\ell X,i}}/{r^{2}_{\ell X}})}{\partial r_{\ell X,j}}
  \end{align}
\end{subequations}
