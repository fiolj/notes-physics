...
\begin{figure}[htbp]
  \centering
  \resizebox{8cm}{!}{\input{figures/coordenadas.tikz}}
...
\intertext{donde}
& \vect{r}=  \vect{r}_{\ce{P}} - \vect{r}_{X} \,, \qquad \qquad
 \vect{r}_{\ell}=  \vect{r}_{\ce{P}} - \vect{r}_{\ce{F_{\ell}}} \,, \qquad \qquad \vect{r}_{\ell X}= \vect{r}_{F_{\ell}} - \vect{r}_{X} \,, \nonumber 
  \end{align}
\end{subequations}
...
donde 
\begin{align}
  A &=  \cos \theta_{\ell} \frac{\partial ({r_{\ell X,i}}/{r_{\ell X}})}{\partial r_{\ell X,j}} + \left( \frac{\partial \cos \theta_{\ell}}{\partial r_{\ell X,j}} \right) \left( \frac{r_{\ell X,i}}{r_{\ell X}} \right) 
\intertext{con}
  & \frac{\partial ({r_{\ell X,i}}/{r_{\ell X}})}{\partial r_{\ell X,j}} = \frac{\delta_{ij}}{r_{\ell X}} - \frac{r_{\ell X,i} r_{\ell X,j}}{r_{\ell X}^{3}} \qquad
    \text{y}\qquad\qquad \frac{\partial \cos \theta_{\ell}}{\partial r_{\ell X,j}}= \frac{1}{r_{\ell X}} \left[\frac{r_{\ell,j}}{r_{\ell}} - \cos{\theta_{\ell}} \frac{r_{\ell X,j}}{r_{\ell X}}\right]
\end{align}
\\
Similarmente $B$ ser\'{a}:
\begin{align}
  B&= 2 \cos \theta_{\ell} \frac{r_{\ell X,i}}{r_{\ell X}}\frac{\partial \cos \theta_{\ell}}{\partial r_{\ell X,j}}  + \cos^{2} \theta_{l}\frac{\partial ({r_{\ell X,i}}/{r^{2}_{\ell X}})}{\partial r_{\ell X,j}}
\end{align}
