...
% \section{Notation, involved magnitudes}
...
Now, we take into account that the number of created dimers does not depend on the particular time $t$ at which they are created. Thus $n_{f}(t,\tau) \equiv n_{f}(\tau)$.
